...
print(f"{nom} a {age} ans.")</code></pre>
...

        {
          ...
          solution: `nom = "Luc"\nage = 16\n\nprint(f"{nom} a {age} ans et sera majeur dans {18 - age} ans.")\n`,
        },
...
Dans 5 ans, elle aura 22 ans.</code></pre>`,
          ...
          solution: `prenom = "Ada"\nage = 17\n\nprint(f"Prénom : {prenom}")\nprint(f"Âge : {age} ans")\nprint(f"Dans 5 ans, elle aura {age + 5} ans.")\n`,
        },
...
3 cahiers coûtent 6 euros</code></pre>`,
          ...
          solution: `article = "Cahier"\nprix = 2\nquantite = 3\n\nprint(f"Article : {article}")\nprint(f"Prix unitaire : {prix} euros")\nprint(f"{quantite} cahiers coûtent {quantite * prix} euros")\n`,
        },
...
Il a donc 27 ans.</code></pre>`,
          ...
          solution: `titre = "Matrix"\nannee = 1999\n\nprint("Le film " + titre + " est sorti en " + str(annee) + ".")\nprint("Il a donc " + str(2026 - annee) + " ans.")\n`,
        },
...
Il fait 18 °C, soit 64.4 °F</code></pre>
          ...
          solution: `ville = input("Ville ? ")\ntemperature = float(input("Température ? "))\n\nprint(f"Bulletin météo pour {ville}")\nprint(f"Il fait {temperature} °C, soit {temperature * 9 / 5 + 32} °F")\n`,
        },
      ],
    },
...
Ada a 17 ans.</code></pre>`,
...

        {
          ...
          solution: `nom = "Link"\npv = 45\npv_max = 60\nannee_sortie = 1986\n\nprint(f"=== {nom} ===")\nprint(f"Points de vie : {pv} / {pv_max}")\nprint(f"Soit {pv * 100 / pv_max} % de vie restante")\nprint(f"Première apparition : {annee_sortie}, il y a {2026 - annee_sortie} ans")\n`,
        },
      ],
    },
  ],
