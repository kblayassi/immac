...
La somme vaut 5.0</code></pre>
          ...
          solution: `nombre_1 = float(input("Premier nombre : "))\nnombre_2 = float(input("Deuxième nombre : "))\n\nprint("La somme vaut", nombre_1 + nombre_2)\n`,
        },
...
17 % 5 = 2</code></pre>
...

        {
          ...
          solution: `quantite = int(input("Combien d'articles ? "))\nprix_unitaire = float(input("Prix unitaire ? "))\n\nprint("Total :", quantite * prix_unitaire)\n`,
        },
...
Moyenne : 15.5</code></pre>`,
          ...
          solution: `a = "10"\nb = "20"\nc = "16.5"\n\nprint("Somme :", int(a) + int(b))\nprint("Produit :", int(a) * int(b))\nprint("Moyenne :", (int(a) + int(b) + float(c)) / 3)\n`,
        },
...
Tu as vécu environ 6205 jours</code></pre>`,
          ...
          solution: `age = int(input("Quel âge as-tu ? "))\n\nprint("Tu as vécu environ", age * 365, "jours")\n`,
        },

        {
          ...
          solution: `duree = 500\n\nprint(duree, "secondes, c'est", duree // 60, "minutes et", duree % 60, "secondes")\n`,
        },
      ],
    },
...
99</code></pre>
          ...
          solution: `nombre = 2\nlettre = "a"\n\nprint(str(nombre) + lettre)\nprint(nombre + ord(lettre))\n`,
        },
...

        {
          ...
          solution: `celsius = float(input("Température en °C ? "))\n\nfahrenheit = celsius * 9 / 5 + 32\nkelvin = celsius + 273.15\n\nprint("Celsius :", celsius)\nprint("Fahrenheit :", fahrenheit)\nprint("Kelvin :", kelvin)\n`,
        },
      ],
    },
  ],
