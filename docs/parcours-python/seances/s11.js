    ...
    /* ================================ LE MÉMO ================================ */
    {
      ...
      etapes: [
...

        {
          ...
          solution: `def etapes_pour_depasser(depart, facteur, seuil):\n    valeur = depart\n    etapes = 0\n    while valeur <= seuil:\n        valeur = valeur * facteur\n        etapes = etapes + 1\n    return etapes\n`,
        },
    ...
    /* ====================== LES ALGORITHMES EXIGIBLES ====================== */
    {
      ...
      etapes: [

        {
          ...
          solution: `def premiere_puissance(base, seuil):\n    puissance = 1\n    while puissance <= seuil:\n        puissance = puissance * base\n    return puissance\n`,
        },
...
Droite verticale d'équation x = 2</code></pre>
          ...
          solution: `def afficher_equation(xa, ya, xb, yb):\n    if xa == xb:\n        print("Droite verticale d'équation x =", xa)\n    else:\n        m = (yb - ya) / (xb - xa)\n        p = ya - m * xa\n        print("y =", m, "x +", p)\n\nafficher_equation(1, 2, 4, 11)\nafficher_equation(2, 0, 2, 5)\n`,
        },
...

        {
          ...
          solution: `def f(x):\n    return -x * x + 4 * x + 1\n\nmeilleur_x = 0\nmeilleur_y = f(0)\n\nfor n in range(4001):\n    x = n / 1000\n    y = f(x)\n    if y > meilleur_y:\n        meilleur_y = y\n        meilleur_x = x\n\nprint("Maximum :", meilleur_y, "atteint en x =", meilleur_x)\n`,
        },
...
Dichotomie : 14 étapes</code></pre>
          ...
          solution: `n = 10000\netapes_balayage = 0\nwhile n * n <= 2 * 10000 * 10000:\n    n = n + 1\n    etapes_balayage = etapes_balayage + 1\n\na = 1\nb = 2\netapes_dichotomie = 0\nwhile b - a > 0.0001:\n    m = (a + b) / 2\n    if m * m < 2:\n        a = m\n    else:\n        b = m\n    etapes_dichotomie = etapes_dichotomie + 1\n\nprint("Balayage :", etapes_balayage, "étapes")\nprint("Dichotomie :", etapes_dichotomie, "étapes")\n`,
        },
...
1000 segments : 1.4789427886161535</code></pre>`,
          ...
          solution: `def f(x):\n    return x * x\n\ndef longueur(n):\n    total = 0\n    dx = 1 / n\n    for i in range(n):\n        x1 = i * dx\n        x2 = (i + 1) * dx\n        dy = f(x2) - f(x1)\n        total = total + (dx * dx + dy * dy) ** 0.5\n    return total\n\nprint(1, "segments :", longueur(1))\nprint(10, "segments :", longueur(10))\nprint(100, "segments :", longueur(100))\nprint(1000, "segments :", longueur(1000))\n`,
        },
...

        {
          ...
          solution: `def somme_arithmetique(premier, raison, n):\n    total = 0\n    terme = premier\n    for i in range(n):\n        total = total + terme\n        terme = terme + raison\n    return total\n\nprint("1 + 2 + ... + 100 =", somme_arithmetique(1, 1, 100))\nprint("1 + 3 + 5 + ... (10 termes) =", somme_arithmetique(1, 2, 10))\nprint("5 + 5 + 5 (3 termes) =", somme_arithmetique(5, 0, 3))\n`,
        },
      ],
    },
  ],
