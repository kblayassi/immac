    ...
    /* ============================= APPLICATION ============================= */
    {
      ...
      etapes: [

        {
          ...
          solution: `# Deuxième implémentation de la file : « entrée en tête ».\n\ndef file_vide():\n    return []\n\ndef est_vide(f):\n    return f == []\n\ndef enfiler(f, element):\n    f.insert(0, element)\n\ndef defiler(f):\n    return f.pop()\n`,
...
repartir(f)  →  [ [1, 3, 5] , [2, 4] ]</code></pre>
          ...
          solution: `# ---- L'implémentation « entrée en fin ». N'y touche pas. ----\n\ndef file_vide():\n    return []\n\ndef est_vide(f):\n    return f == []\n\ndef enfiler(f, element):\n    f.append(element)\n\ndef defiler(f):\n    return f.pop(0)\n\n\n# ---- À toi. ----\n\ndef repartir(f):\n    """Repartit les clients de f alternativement entre deux files.\n\n    Renvoie [guichet_A, guichet_B]. Le premier client va en A.\n    Effet : f est videe.\n    """\n    guichet_a = file_vide()\n    guichet_b = file_vide()\n    tour_de_a = True\n    while not est_vide(f):\n        client = defiler(f)\n        if tour_de_a:\n            enfiler(guichet_a, client)\n        else:\n            enfiler(guichet_b, client)\n        tour_de_a = not tour_de_a\n    return [guichet_a, guichet_b]\n`,
...

        {
          ...
          solution: `# ---- L'implémentation « entrée en fin ». N'y touche pas. ----\n\ndef file_vide():\n    return []\n\ndef est_vide(f):\n    return f == []\n\ndef enfiler(f, element):\n    f.append(element)\n\ndef defiler(f):\n    return f.pop(0)\n\n\n# Ma situation : la file d'impression d'une salle informatique.\n#\n# Le premier document envoyé est le premier imprimé.\n\ndef envoyer_tout(imprimante, documents):\n    """Place tous les documents dans la file d'impression, dans l'ordre."""\n    for document in documents:\n        enfiler(imprimante, document)\n\ndef imprimer(imprimante, nombre):\n    """Imprime au plus nombre documents et renvoie le tableau de leurs noms.\n\n    S'arrete plus tot si la file se vide.\n    """\n    sortis = []\n    for _ in range(nombre):\n        if est_vide(imprimante):\n            return sortis\n        sortis.append(defiler(imprimante))\n    return sortis\n\n\n# ---- Le programme d'essai ----\nimprimante = file_vide()\nenvoyer_tout(imprimante, ["rapport.pdf", "tp_nsi.py", "affiche.png", "notes.txt"])\n\nprint("Premiers imprimés :", imprimer(imprimante, 2))\nprint("Reste-t-il du travail ?", not est_vide(imprimante))\nprint("On termine la pile :", imprimer(imprimante, 10))\n`,
        },
      ],
    },
  ],
