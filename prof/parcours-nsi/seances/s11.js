...
Bonjour Lucie !</code></pre>`,
          ...
          solution: `def dire_bonjour(prenom):\n    print(f"Bonjour {prenom} !")\n\ndire_bonjour("Ali")\ndire_bonjour("Lucie")\n`,
        },
...
10 x 3 = 30</code></pre>`,
          ...
          solution: `def afficher_produit(a, b):\n    print(a, "x", b, "=", a * b)\n\nafficher_produit(12, 7)\nafficher_produit(5, 5)\nafficher_produit(10, 3)\n`,
        },
...
##</code></pre>
          ...
          solution: `def rectangle(largeur, hauteur):\n    for i in range(hauteur):\n        print("#" * largeur)\n\nrectangle(4, 2)\nrectangle(2, 3)\n`,
        },
      ],
    },
...
Décollage !</code></pre>
          ...
          solution: `def compte_a_rebours(depart):\n    for i in range(depart, 0, -1):\n        print(i)\n    print("Décollage !")\n\ncompte_a_rebours(3)\n`,
        },

        {
          ...
          solution: `def encadre(texte, largeur):\n    print("*" * largeur)\n    print("* " + texte)\n    print("*" * largeur)\n\ndef titre(texte):\n    encadre(texte, 24)\n\ntitre("BULLETIN")\ntitre("MOYENNES")\nencadre("Fin du document", 24)\n`,
        },
      ],
    },
  ],
