...
5</code></pre>
          ...
          solution: `# Un maillon est [valeur, suivant]. La chaîne vide est None.\n\ndef maillon(valeur, suivant):\n    """Renvoie un nouveau maillon."""\n    return [valeur, suivant]\n\n\n# ---- À toi. ----\nc = maillon(12, maillon(5, maillon(32, None)))\nprint(c)\nprint(c[0])\nprint(c[1][0])\n`,
    ...
    m = m[1]   # avancer d'un maillon</code></pre>
     ...
     └───┴───┘   └───┴───┘         └───┴───┘
...

        {
          ...
          solution: `# Un maillon est [valeur, suivant]. La chaîne vide est None.\n\ndef maillon(valeur, suivant):\n    return [valeur, suivant]\n\n\n# ---- À toi. ----\n\ndef ajouter_en_fin(c, valeur):\n    """Renvoie la chaine obtenue en accrochant valeur apres le dernier maillon de c."""\n    if c is None:\n        return maillon(valeur, None)\n    m = c\n    while m[1] is not None:\n        m = m[1]\n    m[1] = maillon(valeur, None)\n    return c\n`,
    ...
    /* ============================= APPLICATION ============================= */
    {
      ...
      etapes: [
...

        {
          ...
          solution: `# Un maillon est [valeur, suivant]. Une pile est [premier maillon].\n\ndef maillon(valeur, suivant):\n    return [valeur, suivant]\n\n\n# ---- À toi. ----\n\ndef pile_vide():\n    """Renvoie une pile vide."""\n    return [None]\n\ndef est_vide(p):\n    """Renvoie True si la pile ne contient aucun element."""\n    return p[0] is None\n\ndef empiler(p, element):\n    """Pose element au sommet de la pile."""\n    p[0] = maillon(element, p[0])\n\ndef depiler(p):\n    """Renvoie l'element du sommet, et le retire.\n\n    Precondition : la pile n'est pas vide.\n    """\n    element = p[0][0]\n    p[0] = p[0][1]\n    return element\n`,
...
f[1]  le dernier maillon  — on accroche ici</code></pre>
...

        {
          ...
          solution: `# Un maillon est [valeur, suivant]. Une file est [premier, dernier].\n\ndef maillon(valeur, suivant):\n    return [valeur, suivant]\n\n\n# ---- À toi. ----\n\ndef file_vide():\n    """Renvoie une file vide."""\n    return [None, None]\n\ndef est_vide(f):\n    """Renvoie True si la file ne contient aucun element."""\n    return f[0] is None\n\ndef enfiler(f, element):\n    """Ajoute element a la fin de la file."""\n    neuf = maillon(element, None)\n    if f[0] is None:\n        f[0] = neuf\n    else:\n        f[1][1] = neuf\n    f[1] = neuf\n\ndef defiler(f):\n    """Renvoie le premier element arrive, et le retire.\n\n    Precondition : la file n'est pas vide.\n    """\n    element = f[0][0]\n    f[0] = f[0][1]\n    if f[0] is None:\n        f[1] = None\n    return element\n`,
...
supprimer([12, [5, [32, None]]], 99)  →  [12, [5, [32, None]]]</code></pre>
          ...
          solution: `# Un maillon est [valeur, suivant]. La chaîne vide est None.\n\ndef maillon(valeur, suivant):\n    return [valeur, suivant]\n\n\n# ---- À toi. ----\n\ndef supprimer(c, valeur):\n    """Renvoie la chaine privee du premier maillon portant valeur.\n\n    Si aucun maillon ne la porte, la chaine est rendue inchangee.\n    """\n    if c is None:\n        return None\n    if c[0] == valeur:\n        return c[1]\n    m = c\n    while m[1] is not None and m[1][0] != valeur:\n        m = m[1]\n    if m[1] is not None:\n        m[1] = m[1][1]\n    return c\n`,
...

        {
          ...
          solution: `# Un maillon est [valeur, suivant].\n# Une chaîne comptée est [premier maillon, nombre de maillons].\n\ndef maillon(valeur, suivant):\n    return [valeur, suivant]\n\n\n# ---- À toi. ----\n\ndef comptee_vide():\n    """Renvoie une chaine comptee sans aucun maillon."""\n    return [None, 0]\n\ndef comptee_longueur(cc):\n    """Renvoie le nombre de maillons, en temps constant."""\n    return cc[1]\n\ndef comptee_ajouter(cc, valeur):\n    """Accroche un maillon de valeur en tete. Ne renvoie rien."""\n    cc[0] = maillon(valeur, cc[0])\n    cc[1] = cc[1] + 1\n\ndef comptee_retirer(cc):\n    """Retire le premier maillon et renvoie sa valeur.\n\n    Precondition : la chaine n'est pas vide.\n    """\n    valeur = cc[0][0]\n    cc[0] = cc[0][1]\n    cc[1] = cc[1] - 1\n    return valeur\n`,
...
[1]              →  1</code></pre>
          ...
          solution: `# Un maillon est [valeur, suivant]. La chaîne vide est None.\n\ndef maillon(valeur, suivant):\n    return [valeur, suivant]\n\ndef depuis_tableau(t):\n    """Fournie, pour tes essais."""\n    c = None\n    for i in range(len(t) - 1, -1, -1):\n        c = maillon(t[i], c)\n    return c\n\n\n# ---- À toi. ----\n\ndef milieu(c):\n    """Renvoie la valeur du maillon du milieu de c, en un seul parcours.\n\n    Pour un nombre pair de maillons, c'est celui de rang n // 2.\n    Precondition : c n'est pas vide.\n    """\n    lente = c\n    rapide = c\n    while rapide is not None and rapide[1] is not None:\n        lente = lente[1]\n        rapide = rapide[1][1]\n    return lente[0]\n`,
...
résultat : 1 ──▶ 2 ──▶ 3 ──▶ 4 ──▶ 9 ──▶ 10</code></pre>
...

        {
          ...
          solution: `# Un maillon est [valeur, suivant]. La chaîne vide est None.\n\ndef maillon(valeur, suivant):\n    return [valeur, suivant]\n\n\n# Ma structure : l'ensemble trié sans doublons.\n#\n# Les maillons sont maintenus en ordre croissant, et une valeur\n# déjà présente n'est pas ajoutée une seconde fois.\n\ndef ensemble_vide():\n    """Renvoie un ensemble ne contenant aucune valeur."""\n    return None\n\ndef ajouter(e, valeur):\n    """Renvoie l'ensemble e avec valeur, sans creer de doublon."""\n    if e is None or valeur < e[0]:\n        return maillon(valeur, e)\n    if e[0] == valeur:\n        return e\n    m = e\n    while m[1] is not None and m[1][0] < valeur:\n        m = m[1]\n    if m[1] is not None and m[1][0] == valeur:\n        return e\n    m[1] = maillon(valeur, m[1])\n    return e\n\ndef cardinal(e):\n    """Renvoie le nombre de valeurs distinctes de l'ensemble e."""\n    n = 0\n    m = e\n    while m is not None:\n        n = n + 1\n        m = m[1]\n    return n\n\ndef vers_tableau(e):\n    """Renvoie le tableau des valeurs de e, par ordre croissant."""\n    t = []\n    m = e\n    while m is not None:\n        t.append(m[0])\n        m = m[1]\n    return t\n\n\n# ---- Le programme d'essai ----\nmon_ensemble = ensemble_vide()\nfor v in [5, 2, 9, 2, 5, 7]:\n    mon_ensemble = ajouter(mon_ensemble, v)\n\nprint("Contenu :", vers_tableau(mon_ensemble))\nprint("Cardinal :", cardinal(mon_ensemble))\nprint("Après ajout de 1 :", vers_tableau(ajouter(mon_ensemble, 1)))\n`,
        },
      ],
    },
  ],
