...
evaluer(["7"])                      →  7</code></pre>
          ...
          solution: `# ---- La pile. N'y touche pas. ----\n\ndef pile_vide():\n    return []\n\ndef est_vide(p):\n    return p == []\n\ndef empiler(p, element):\n    p.append(element)\n\ndef depiler(p):\n    return p.pop()\n\n\n# ---- À toi. ----\n\ndef evaluer(expression):\n    """Renvoie la valeur de l'expression en notation polonaise inverse.\n\n    expression est un tableau de chaines : des nombres, "+" ou "*".\n    Precondition : l'expression est bien formee.\n    """\n    p = pile_vide()\n    for jeton in expression:\n        if jeton == "+":\n            b = depiler(p)\n            a = depiler(p)\n            empiler(p, a + b)\n        elif jeton == "*":\n            b = depiler(p)\n            a = depiler(p)\n            empiler(p, a * b)\n        else:\n            empiler(p, int(jeton))\n    return depiler(p)\n`,
...
max_pile(p, 4)  →  3     parmi tous, le plus grand est 9, à 3 crans du sommet</code></pre>
      ...
      ▁▁▁▁▁▁▁▁▁    ───▶      ▁▁▁▁▁▁▁
       ...
       en désordre            triées</code></pre>
          ...
          solution: `# ---- Fournies : la pile, hauteur, max_pile, retourner. N'y touche pas. ----\n\ndef pile_vide():\n    return []\n\ndef est_vide(p):\n    return p == []\n\ndef empiler(p, element):\n    p.append(element)\n\ndef depiler(p):\n    return p.pop()\n\ndef hauteur(p):\n    reserve = pile_vide()\n    n = 0\n    while not est_vide(p):\n        empiler(reserve, depiler(p))\n        n = n + 1\n    while not est_vide(reserve):\n        empiler(p, depiler(reserve))\n    return n\n\ndef max_pile(p, i):\n    """Profondeur du plus grand des i elements du sommet. 1 s'il y est deja."""\n    reserve = pile_vide()\n    plus_grand = depiler(p)\n    empiler(reserve, plus_grand)\n    profondeur = 1\n    for k in range(2, i + 1):\n        x = depiler(p)\n        empiler(reserve, x)\n        if x > plus_grand:\n            plus_grand = x\n            profondeur = k\n    for k in range(i):\n        empiler(p, depiler(reserve))\n    return profondeur\n\ndef retourner(p, k):\n    """Inverse l'ordre des k elements du sommet de p."""\n    a = pile_vide()\n    b = pile_vide()\n    for _ in range(k):\n        empiler(a, depiler(p))\n    for _ in range(k):\n        empiler(b, depiler(a))\n    for _ in range(k):\n        empiler(p, depiler(b))\n\n\n# ---- À toi. ----\n\ndef tri_crepes(p):\n    """Trie la pile p : le plus grand au fond, le plus petit au sommet.\n\n    Effet : p est modifiee. La fonction ne renvoie rien.\n    """\n    n = hauteur(p)\n    for i in range(n, 1, -1):\n        profondeur = max_pile(p, i)\n        retourner(p, profondeur)\n        retourner(p, i)\n`,
...
pour i de n jusqu'à 2 :
    ...
    retourner(p, i)                # il part au fond du bloc de i</code></pre>`,
...

        {
          ...
          solution: `# ---- Fournies et justes. N'y touche pas. ----\n\ndef pile_vide():\n    return []\n\ndef est_vide(p):\n    return p == []\n\ndef empiler(p, element):\n    p.append(element)\n\ndef depiler(p):\n    return p.pop()\n\ndef hauteur(p):\n    reserve = pile_vide()\n    n = 0\n    while not est_vide(p):\n        empiler(reserve, depiler(p))\n        n = n + 1\n    while not est_vide(reserve):\n        empiler(p, depiler(reserve))\n    return n\n\ndef max_pile(p, i):\n    reserve = pile_vide()\n    plus_grand = depiler(p)\n    empiler(reserve, plus_grand)\n    profondeur = 1\n    for k in range(2, i + 1):\n        x = depiler(p)\n        empiler(reserve, x)\n        if x > plus_grand:\n            plus_grand = x\n            profondeur = k\n    for k in range(i):\n        empiler(p, depiler(reserve))\n    return profondeur\n\ndef retourner(p, k):\n    a = pile_vide()\n    b = pile_vide()\n    for _ in range(k):\n        empiler(a, depiler(p))\n    for _ in range(k):\n        empiler(b, depiler(a))\n    for _ in range(k):\n        empiler(p, depiler(b))\n\n\n# ---- À réparer. ----\n\ndef tri_crepes(p):\n    """Trie la pile p : le plus grand au fond, le plus petit au sommet."""\n    n = hauteur(p)\n    for i in range(n, 1, -1):\n        retourner(p, max_pile(p, i))\n        retourner(p, i)\n`,
...
"#######"</code></pre>
          ...
          solution: `# ---- La pile, et deux aides. N'y touche pas. ----\n\ndef pile_vide():\n    return []\n\ndef est_vide(p):\n    return p == []\n\ndef empiler(p, element):\n    p.append(element)\n\ndef depiler(p):\n    return p.pop()\n\ndef trouver(laby, marque):\n    """Renvoie [ligne, colonne] de la case portant marque."""\n    for i in range(len(laby)):\n        for j in range(len(laby[i])):\n            if laby[i][j] == marque:\n                return [i, j]\n    return None\n\ndef voisins(laby, case):\n    """Renvoie le tableau des cases praticables voisines de case."""\n    i = case[0]\n    j = case[1]\n    resultat = []\n    for pas in [[-1, 0], [1, 0], [0, -1], [0, 1]]:\n        li = i + pas[0]\n        co = j + pas[1]\n        if 0 <= li < len(laby) and 0 <= co < len(laby[li]):\n            if laby[li][co] != "#":\n                resultat.append([li, co])\n    return resultat\n\n\nLABY = [\n    "#######",\n    "#D..#.#",\n    "#.#.#.#",\n    "#.#...#",\n    "#....A#",\n    "#######",\n]\n\nMURE = [\n    "#####",\n    "#D#A#",\n    "#####",\n]\n\n\n# ---- À toi. ----\n\ndef accessible(laby):\n    """Renvoie True si l'arrivee est atteignable depuis le depart."""\n    depart = trouver(laby, "D")\n    arrivee = trouver(laby, "A")\n    a_explorer = pile_vide()\n    empiler(a_explorer, depart)\n    vues = {}\n    vues[(depart[0], depart[1])] = True\n    while not est_vide(a_explorer):\n        case = depiler(a_explorer)\n        if case == arrivee:\n            return True\n        for voisine in voisins(laby, case):\n            cle = (voisine[0], voisine[1])\n            if cle not in vues:\n                vues[cle] = True\n                empiler(a_explorer, voisine)\n    return False\n`,
...

        {
          ...
          solution: `# ---- La file, et deux aides. N'y touche pas. ----\n\ndef file_vide():\n    return []\n\ndef est_vide(f):\n    return f == []\n\ndef enfiler(f, element):\n    f.append(element)\n\ndef defiler(f):\n    return f.pop(0)\n\ndef trouver(laby, marque):\n    for i in range(len(laby)):\n        for j in range(len(laby[i])):\n            if laby[i][j] == marque:\n                return [i, j]\n    return None\n\ndef voisins(laby, case):\n    i = case[0]\n    j = case[1]\n    resultat = []\n    for pas in [[-1, 0], [1, 0], [0, -1], [0, 1]]:\n        li = i + pas[0]\n        co = j + pas[1]\n        if 0 <= li < len(laby) and 0 <= co < len(laby[li]):\n            if laby[li][co] != "#":\n                resultat.append([li, co])\n    return resultat\n\n\nLABY = [\n    "#######",\n    "#D..#.#",\n    "#.#.#.#",\n    "#.#...#",\n    "#....A#",\n    "#######",\n]\n\nMURE = [\n    "#####",\n    "#D#A#",\n    "#####",\n]\n\n\n# ---- À toi. ----\n\ndef distance(laby):\n    """Renvoie le nombre minimal de deplacements du depart a l'arrivee.\n\n    Renvoie -1 si l'arrivee n'est pas atteignable.\n    """\n    depart = trouver(laby, "D")\n    arrivee = trouver(laby, "A")\n    if depart is None or arrivee is None:\n        return -1\n    a_explorer = file_vide()\n    enfiler(a_explorer, [depart, 0])\n    vues = {}\n    vues[(depart[0], depart[1])] = True\n    while not est_vide(a_explorer):\n        courant = defiler(a_explorer)\n        case = courant[0]\n        pas = courant[1]\n        if case == arrivee:\n            return pas\n        for voisine in voisins(laby, case):\n            cle = (voisine[0], voisine[1])\n            if cle not in vues:\n                vues[cle] = True\n                enfiler(a_explorer, [voisine, pas + 1])\n    return -1\n`,
...

        {
          ...
          solution: `# ---- La file, et deux aides. N'y touche pas. ----\n\ndef file_vide():\n    return []\n\ndef est_vide(f):\n    return f == []\n\ndef enfiler(f, element):\n    f.append(element)\n\ndef defiler(f):\n    return f.pop(0)\n\ndef trouver(laby, marque):\n    for i in range(len(laby)):\n        for j in range(len(laby[i])):\n            if laby[i][j] == marque:\n                return [i, j]\n    return None\n\ndef voisins(laby, case):\n    i = case[0]\n    j = case[1]\n    resultat = []\n    for pas in [[-1, 0], [1, 0], [0, -1], [0, 1]]:\n        li = i + pas[0]\n        co = j + pas[1]\n        if 0 <= li < len(laby) and 0 <= co < len(laby[li]):\n            if laby[li][co] != "#":\n                resultat.append([li, co])\n    return resultat\n\n\nLABY = [\n    "#######",\n    "#D..#.#",\n    "#.#.#.#",\n    "#.#...#",\n    "#....A#",\n    "#######",\n]\n\n\n# ---- À toi. ----\n\ndef chemin(laby):\n    """Renvoie le tableau des cases du plus court chemin, depart et arrivee inclus.\n\n    Renvoie [] si l'arrivee n'est pas atteignable.\n    """\n    depart = trouver(laby, "D")\n    arrivee = trouver(laby, "A")\n    if depart is None or arrivee is None:\n        return []\n    a_explorer = file_vide()\n    enfiler(a_explorer, depart)\n    venant_de = {}\n    venant_de[(depart[0], depart[1])] = None\n    trouvee = False\n    while not est_vide(a_explorer) and not trouvee:\n        case = defiler(a_explorer)\n        if case == arrivee:\n            trouvee = True\n        else:\n            for voisine in voisins(laby, case):\n                cle = (voisine[0], voisine[1])\n                if cle not in venant_de:\n                    venant_de[cle] = case\n                    enfiler(a_explorer, voisine)\n    if not trouvee:\n        return []\n    envers = []\n    case = arrivee\n    while case is not None:\n        envers.append(case)\n        case = venant_de[(case[0], case[1])]\n    resultat = []\n    for k in range(len(envers) - 1, -1, -1):\n        resultat.append(envers[k])\n    return resultat\n`,
...
résultat : ["B", "C", "A"]</code></pre>`,
          ...
          solution: `# ---- La file. N'y touche pas. ----\n\ndef file_vide():\n    return []\n\ndef est_vide(f):\n    return f == []\n\ndef enfiler(f, element):\n    f.append(element)\n\ndef defiler(f):\n    return f.pop(0)\n\n\n# ---- À toi. ----\n\ndef tourniquet(taches, quantum):\n    """Renvoie le tableau des noms, dans l'ordre ou les taches se terminent.\n\n    taches est un tableau de couples [nom, duree].\n    Une tache qui ne finit pas repart a la fin de la file.\n    Effet : le tableau recu n'est pas modifie.\n    """\n    attente = file_vide()\n    for tache in taches:\n        enfiler(attente, [tache[0], tache[1]])\n    terminees = []\n    while not est_vide(attente):\n        tache = defiler(attente)\n        if tache[1] <= quantum:\n            terminees.append(tache[0])\n        else:\n            tache[1] = tache[1] - quantum\n            enfiler(attente, tache)\n    return terminees\n`,
   ...
   →  [14, 7]</code></pre>
          ...
          solution: `# ---- La pile. N'y touche pas. ----\n\ndef pile_vide():\n    return []\n\ndef est_vide(p):\n    return p == []\n\ndef empiler(p, element):\n    p.append(element)\n\ndef depiler(p):\n    return p.pop()\n\nOPERATEURS = ["+", "-", "*", "//"]\n\n\n# ---- À toi. ----\n\ndef evaluer(jetons, variables):\n    """Renvoie la valeur de l'expression, en lisant les variables dans variables.\n\n    jetons est un tableau de chaines : nombres, operateurs, ou noms de variables.\n    variables est un dictionnaire nom -> valeur.\n    """\n    p = pile_vide()\n    for jeton in jetons:\n        if jeton in OPERATEURS:\n            droite = depiler(p)\n            gauche = depiler(p)\n            if jeton == "+":\n                empiler(p, gauche + droite)\n            elif jeton == "-":\n                empiler(p, gauche - droite)\n            elif jeton == "*":\n                empiler(p, gauche * droite)\n            else:\n                empiler(p, gauche // droite)\n        elif jeton in variables:\n            empiler(p, variables[jeton])\n        else:\n            empiler(p, int(jeton))\n    return depiler(p)\n\ndef executer(programme):\n    """Execute les lignes et renvoie le tableau des valeurs affichees.\n\n    Une ligne est soit "nom = expression", soit "afficher expression".\n    """\n    variables = {}\n    affichages = []\n    for ligne in programme:\n        jetons = ligne.split()\n        if jetons[0] == "afficher":\n            affichages.append(evaluer(jetons[1:], variables))\n        else:\n            variables[jetons[0]] = evaluer(jetons[2:], variables)\n    return affichages\n`,
...

        {
          ...
          solution: `# Mon problème : le simulateur d'ascenseur.\n#\n# Structure 1 : une FILE des étages appelés, pour répondre à\n#               « quel est le prochain étage à desservir ? » — ordre d'appel.\n# Structure 2 : un DICTIONNAIRE étage -> nombre de passages, pour répondre à\n#               « combien de fois est-on passé à cet étage ? » — immédiat.\n\ndef ascenseur_neuf():\n    """Renvoie un ascenseur au rez-de-chaussee, sans appel en attente."""\n    return [0, [], {}]\n\ndef appeler(a, etage):\n    """Enregistre un appel pour cet etage, a la fin de la file."""\n    a[1].append(etage)\n\ndef desservir(a):\n    """Dessert le prochain etage appele et renvoie le nombre d'etages parcourus.\n\n    Precondition : au moins un appel est en attente.\n    """\n    etage = a[1].pop(0)\n    distance = abs(etage - a[0])\n    a[0] = etage\n    if etage in a[2]:\n        a[2][etage] = a[2][etage] + 1\n    else:\n        a[2][etage] = 1\n    return distance\n\ndef etage_le_plus_demande(a):\n    """Renvoie l'etage le plus souvent desservi, ou -1 si aucun ne l'a ete."""\n    meilleur = -1\n    for etage in a[2]:\n        if meilleur == -1 or a[2][etage] > a[2][meilleur]:\n            meilleur = etage\n    return meilleur\n\n\n# ---- Le programme d'essai ----\na = ascenseur_neuf()\nappeler(a, 3)\nappeler(a, 1)\nappeler(a, 3)\nappeler(a, 5)\n\ntotal = 0\nwhile a[1] != []:\n    total = total + desservir(a)\n\nprint("Étage final :", a[0])\nprint("Étages parcourus :", total)\nprint("Étage le plus demandé :", etage_le_plus_demande(a))\nprint("Passages par étage :", a[2])\n`,
        },
      ],
    },
  ],
