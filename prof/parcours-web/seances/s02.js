...
` },
          ...
          solution: {
            "index.html": `<h1>Pâte à crêpes</h1>
<h2>Ingrédients</h2>
<ul>
  <li>3 œufs</li>
  <li>250 g de farine</li>
...
<ol>
  ...
  <li>Verser le lait peu à peu</li>
...
` },
          ...
          solution: {
            "index.html": `<h1>Pâte à crêpes</h1>
<img src="../files/SNT/Web/crepes.svg" alt="Une pile de crêpes dorées">
<h2>Ingrédients</h2>
<ul>
  <li>3 œufs</li>
  <li>250 g de farine</li>
...
` },
          ...
          solution: {
            "index.html": `<h1>Ma recette du moment</h1>
<p>Une photo pour donner envie :</p>
<img src="https://upload.wikimedia.org/wikipedia/commons/6/6b/Crepe.jpg" alt="Une crêpe dans une poêle">
`,
          },
...
<p>Recette adaptée depuis <a href="https://www.marmiton.org">le site Marmiton</a>.</p>
`,
          },
...
` },
          ...
          solution: {
            "index.html": `<h1>Mon carnet de recettes</h1>
<p>Les recettes que je réussis à tous les coups.</p>
<ul>
  <li><a href="crepes.html">Pâte à crêpes</a></li>
</ul>
`,
            "crepes.html": `<h1>Pâte à crêpes</h1>
<p>Trois œufs, de la farine, du lait, et une heure de repos.</p>
`,
          },
...
<html lang="fr">
  ...
  <body>
    ...
    <img src="../files/SNT/Web/tarte-pommes.svg" alt="Une tarte aux pommes en rosace">
    <h2>Ingrédients</h2>
    <ul>
      <li>1 pâte brisée</li>
      <li>4 pommes</li>
    ...
    <h2>Préparation</h2>
    <ol>
      <li>Étaler la pâte dans le moule</li>
...
`,
            "tarte.html": `<h1>Tarte aux pommes</h1>
<p>Une pâte brisée, quatre pommes, du sucre et du beurre.</p>
<p><a href="index.html">Retour au sommaire</a></p>
`,
          },
...
` },
          ...
          solution: {
            "index.html": `<h1>Gâteau au yaourt</h1>
<img src="../files/SNT/Web/saladier.svg" alt="Un saladier et des œufs">
<h2>Ingrédients</h2>
<ul>
...
<p>Recette vue sur <a href="https://www.marmiton.org">le site de Marmiton</a>.</p>
`,
          },
...
` },
          ...
          solution: {
            "index.html": `<h1>Deux desserts faciles</h1>
<img src="../files/SNT/Web/crepes.svg" alt="Une pile de crêpes dorées">
<img src="../files/SNT/Web/tarte-pommes.svg" alt="Une tarte aux pommes en rosace">
<p>Les recettes viennent du <a href="https://www.marmiton.org">site Marmiton</a>.</p>
`,
          },
...
` },
          ...
          solution: {
            "index.html": `<h1>Mon carnet de recettes</h1>
<p>Deux recettes simples, testées et approuvées à la maison.</p>
<img src="../files/SNT/Web/saladier.svg" alt="Un saladier et des œufs">
<ul>
  <li><a href="recette1.html">Pâte à crêpes</a></li>
  <li><a href="recette2.html">Tarte aux pommes</a></li>
</ul>
`,
            "recette1.html": `<h1>Pâte à crêpes</h1>
<img src="../files/SNT/Web/crepes.svg" alt="Une pile de crêpes dorées">
<h2>Ingrédients</h2>
<ul>
  <li>3 œufs</li>
...
<p><a href="index.html">Retour au sommaire</a></p>
`,
            "recette2.html": `<h1>Tarte aux pommes</h1>
<img src="../files/SNT/Web/tarte-pommes.svg" alt="Une tarte aux pommes en rosace">
<h2>Ingrédients</h2>
<ul>
  <li>1 pâte brisée</li>
...
` },
          ...
          solution: {
            "index.html": `<h1>Deux desserts</h1>
<ul>
  <li><a href="crepes.html">Pâte à crêpes</a></li>
  <li><a href="tarte.html">Tarte aux pommes</a></li>
</ul>
...
<html lang="fr">
  ...
  <body>
    <h1>Le badminton</h1>
    <img src="../files/SNT/Web/saladier.svg" alt="Une illustration de saladier provisoire">
    <h2>Le matériel</h2>
    <ul>
      <li>Une raquette légère</li>
      <li>Des volants en plumes</li>
      <li>Des chaussures de salle</li>
    </ul>
    <h2>Le déroulement d'un match</h2>
    <ol>
      <li>On tire au sort le premier serveur</li>
      <li>On joue en trois sets gagnants de 21 points</li>
      <li>On change de côté à chaque set</li>
    </ol>
    <p>Les règles complètes sont sur <a href="https://www.ffbad.org">le site de la fédération</a>.</p>
    <p>L'histoire du sport est résumée sur <a href="https://fr.wikipedia.org/wiki/Badminton">la page Wikipédia du badminton</a>.</p>
  </body>
</html>
`,
          },
