...
<html lang="fr">
  ...
  <body>
    <h1>Pâte à crêpes</h1>
    <p>Mélange la farine, les œufs et le lait.</p>
    <p class="astuce">Laisse reposer la pâte une heure avant de cuire.</p>
  </body>
</html>
`,
            "style.css": `body {
...
<html lang="fr">
  ...
  <body>
    ...
    <p>Mélange la farine, les œufs et le lait.</p>
    <p class="astuce">Laisse reposer la pâte une heure avant de cuire.</p>
    <p class="danger">Attention, la poêle doit être brûlante avant la première crêpe.</p>
  </body>
</html>
`,
            "style.css": `body {
...
h1 {
  color: #5B3A1A;
  text-align: center;
  border-bottom: 3px solid #D8C5A4;
}
...
<html lang="fr">
  <head>
    <meta charset="utf-8">
    <title>La cuisine du dimanche</title>
    <link rel="stylesheet" href="style.css">
  </head>
  <body>
    <h1>La cuisine du dimanche</h1>
    <img src="../files/SNT/Web/tarte-pommes.svg" alt="Une tarte aux pommes en rosace">
    <p class="intro">Trois plats que je refais tous les week-ends d'automne.</p>
    <h2>Les ingrédients de base</h2>
    <ul>
      <li>Des pommes du marché</li>
      <li>Une pâte brisée</li>
      <li>Du beurre demi-sel</li>
    </ul>
    <h2>Pour aller plus loin</h2>
    <p>D'autres idées sur <a href="https://www.marmiton.org">le site Marmiton</a>.</p>
  </body>
</html>
`,
            "style.css": `body {
