...
` },
          ...
          solution: {
            "index.html": `<h1>Mes recettes préférées</h1>
`,
          },
...
` },
          ...
          solution: {
            "index.html": `<h1>Mes recettes préférées</h1>
<p>Sur ce site, je rassemble les recettes que je réussis à tous les coups.</p>
<p>Je m'appelle Lina et je cuisine depuis que je suis petite.</p>
`,
          },
...
` },
          ...
          solution: {
            "index.html": `<h1>Où me trouver</h1>
<p>Chez Lina<br>12 rue des Lilas<br>75011 Paris</p>
`,
          },
...
<html lang="fr">
  <head>
    <meta charset="utf-8">
    <title>Les recettes de Lina</title>
  </head>
  <body>
    <h1>Les recettes de Lina</h1>
    <p>Trois recettes simples que je réussis à tous les coups.</p>
  </body>
</html>
`,
          },
...
` },
          ...
          solution: {
            "index.html": `<h1>Crème anglaise</h1>
<p>Fais chauffer le lait pendant <strong>vingt minutes</strong>, en remuant <em>doucement</em>.</p>
`,
          },
...
<html lang="fr">
  ...
  <body>
    <h1>Crêpes</h1>
    <p>La recette de base, celle qu'on connaît par cœur au bout de trois fois.</p>
    <h2>Ingrédients</h2>
    <p>Trois œufs, 250 g de farine, un demi-litre de lait et une pincée de sel.</p>
    <h2>Préparation</h2>
    <p>Mélange la farine et les œufs, verse le lait peu à peu, laisse reposer une heure.</p>
  </body>
</html>
`,
          },
...
<html lang="fr">
  ...
  <body>
    <h1>Pain perdu</h1>
    <p>Une recette <strong>anti-gaspi</strong> : elle sauve le pain de la veille.</p>
    <h2>Le secret</h2>
    <p>Laisser tremper <em>longtemps</em>.<br>Vraiment longtemps.</p>
  </body>
</html>
`,
          },
...
<html lang="fr">
  ...
  <body>
    ...
    <p>Un dessert de dernière minute.</p>
    <h2>Ingrédients</h2>
    <p>Une pomme, une banane, deux kiwis.<br>Un peu de jus de citron.</p>
  </body>
</html>
...
<html lang="fr">
  ...
  <body>
    <h1>Gâteau au yaourt</h1>
    <p>Le premier gâteau que tout le monde apprend à faire.</p>
    <!-- Ajouter une photo du gâteau au-dessus de cette partie -->
    <h2>Préparation</h2>
    <p>Le pot de yaourt sert de verre doseur pour tout le reste.</p>
    <p>Compter trente minutes de cuisson à 180 degrés.</p>
  </body>
</html>
`,
          },
...
<html lang="fr">
  <head>
    <meta charset="utf-8">
    <title>Le Petit Comptoir</title>
  </head>
  <body>
    <h1>Le Petit Comptoir</h1>
    <p>Une cuisine simple, de saison, servie midi et soir.</p>
    <h2>Entrées</h2>
    <p><strong>Soupe de courge</strong> au lait de coco<br><strong>Salade craquante</strong> et graines torréfiées</p>
    <h2>Plats</h2>
    <p><strong>Risotto aux champignons</strong><br><strong>Poisson du jour</strong> et pommes de terre écrasées</p>
    <h2>Desserts</h2>
    <p><strong>Tarte aux pommes</strong> tiède<br><strong>Mousse au chocolat</strong> maison</p>
  </body>
</html>
`,
          },
...
<html lang="fr">
  ...
  <body>
    <h1>Soupe à l'oignon</h1>
    <p>Un classique <strong>d'hiver</strong></p>
    <h2>Ingrédients</h2>
    <p>Six oignons, un bouillon, du pain rassis et du fromage.</p>
  </body>
</html>
...
<html lang="fr">
  <head>
    <meta charset="utf-8">
    <title>Le grimpeur de bloc</title>
  </head>
  <body>
    <!-- Page écrite pour le défi libre de la séance 1 -->
    <h1>L'escalade de bloc</h1>
    <p>Le bloc se pratique sur des murs de quatre mètres, sans corde et sans baudrier.</p>
    <h2>Le matériel</h2>
    <p>Il faut des <strong>chaussons</strong>, un sac de magnésie et surtout un gros tapis.</p>
    <h2>Le vocabulaire</h2>
    <p>Un passage s'appelle un <em>bloc</em>.<br>Le réussir du premier coup s'appelle un flash.</p>
  </body>
</html>
`,
          },
